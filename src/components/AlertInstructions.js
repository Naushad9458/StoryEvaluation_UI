      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            ...
            <p style={{color:'red'}}>6. Always answer the questions first based on the original narratives and then proceed to editing if need be and finally click 'Submit'</p>
            <p><b>5. There are multiple narratives for each set of images. Repeat steps 1-4 for each of narratives displayed</b> <br/></p>
            <p>6. The scores you assign to narratives (for the 3 questions) are relative. A strong analogy could be when you are marking student's answer sheets in a class <br/></p>
          </DialogContentText>
        </DialogContent>
        <DialogActions>
